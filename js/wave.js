...
const wave_upgrades = [{
	...
	unlocked() {return game.unlocks.includes("w")},
}, {
	title: "COOLHEADED",
	desc() {return "increases the minimum value of your wave by " + format(0.25)},
	effect() {return game.wave.upgrades[1] * 0.25},
	cost() {return ((game.wave.upgrades[7] > 0 ? 1.4 : 1.5) ** game.wave.upgrades[1]) * 25 / wave_upgrades[5].effect()},
}, {
	title: "WEAKEN CHAINS",
	...
	cost() {return (5 ** game.wave.upgrades[4]) * 250 / wave_upgrades[9].effect()},
	...
	cost() {return (5 ** game.wave.upgrades[5]) * 500 / wave_upgrades[9].effect()},
}, {
	title: "MATHEMATICAL",
	...
	title: "SMOOTH SCALE",
	desc: "improves the cost formulas of COOLHEADED and WEAKEN CHAINS",
	cost: 25000,
	max: 1,
}, {
	title: "UNSTOPPABLE",
	...
	effect() {return (game.wave.upgrades[9] ? 1.75 : 1)},
	cost: 5e18,
	max: 1,
...
for (let index = 0; index < wave_upgrades.length; index++) {
	if (wave_upgrades[index].unlocked === undefined) wave_upgrades[index].unlocked = () => {return game.wave.upgrades[index - 1]};
};
