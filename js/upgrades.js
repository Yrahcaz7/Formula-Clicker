const upgrades = [{
	...
	unlocked() {return game.pointTotal.gte(20)},
}, {
	...
	unlocked() {return game.pointTotal.gte(225) && game.upgrades[0] > 0},
}, {
	title: "SECONDARY",
	...
	unlocked() {return game.pointTotal.gte(750) && game.upgrades[1] > 0},
}, {
	title: "MASS MULT",
	...
	unlocked() {return game.pointTotal.gte(4500) && game.upgrades[2] > 0},
}, {
	title: "TERTIARY",
	...
	unlocked() {return game.pointTotal.gte(1500000) && game.upgrades[3] > 0},
}, {
	title: "FAST SCALING",
	...
	unlocked() {return game.pointTotal.gte(9000000) && game.upgrades[4] > 0},
}, {
	title: "QUATERNARY",
	...
	unlocked() {return game.pointTotal.gte(1.5e11) && game.upgrades[5] > 0},
}, {
	title: "EXPONENTIAL",
	...
	unlocked() {return game.pointTotal.gte(9e11) && game.upgrades[6] > 0},
}, {
	title: "QUINARY",
	...
	unlocked() {return game.pointTotal.gte(1.5e29) && game.improvements[5] > 2 && game.upgrades[7] > 0},
}, {
	...
	unlocked() {return game.pointTotal.gte(1.5e30) && game.upgrades[8] > 0},
}, {
	title: "SENARY",
	...
	unlocked() {return game.pointTotal.gte(1.5e55) && game.improvements[10] && game.upgrades[9] > 0},
}, {
	title: "NEVER-ENDING",
	...
	unlocked() {return game.pointTotal.gte(1.5e57) && game.upgrades[10] > 0},
}, {
	title: "TO THE BEYOND",
